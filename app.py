...
def finalize_sheet(ws, style_row_cells):
    ...
    # ✅ MICRO FIX #1 : enlever "cible" en A6
    ws["A6"].value = None
    ...
    # ✅ MICRO FIX #2 : vider TOUTES les autres colonnes de la ligne Total (C..N)
    # (comme ça, la ligne Total n'affiche que A et B, sans bordures ailleurs)
    empty_border = Border()
